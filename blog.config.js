...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '堃', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '做一个快乐的猪，还是忧郁的猪，这是个问题', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://zcosmos.blog', // 网站地址
